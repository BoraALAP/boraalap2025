...
const projects = [
  ...
  },
  {
    title: "Spline Blend",
    description: "Playground",
    component: Splineblend,
  },
  {
    title: "Hiroo",
    description: "Web Design / Freelance",
    href: "https://hiroo.co",
    image: Hiroo,
  },
  {
    title: "Profillet",
    description: "Branding / Freelance",
    image: ProfilletBranding,
  },
  {
    title: "Profillet",
    description: "Web Design / Freelance",
  ...
  {
    title: "Ekar",
    description: "Mobile App Design / Freelance",
    image: EkarMobile,
  },
  // { title: "Ekar", description: "Web Design / Freelance", image: EkarWeb },
];

// TwentyTwentyFivePage preserves the previous design portfolio at /2025.
export default function TwentyTwentyFivePage() {
  return (
    <div className="">
      <Introduction title="Product Design Lead / Design Engineer">
        ...
        who spends the day crafting delightful digital experiences and the night
        honing my development skills by bringing designs to life. Whether it’s
        perfecting a user journey or coding an interactive prototype, I’m always
        exploring ways to bridge creativity and technology.
      </Introduction>
      <Work />
      <MyStack
        message="I’m dedicated to evolving my craft, embracing new tools and techniques to stay versatile and deliver meaningful, user-centered experiences."
        brand={{
          title: "Design",
          brands: ["Figma", "Jira", "Framer", "Play 2", "Spline"],
        }}
      />
      <Experiences />
