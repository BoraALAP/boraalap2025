...
/**
 * ConnectPage preserves the older FreshBooks Connect case study inside /2025.
 * It keeps the original section navigation, imagery, and next-project link.
 */
...
import challenge from "../../../../../public/projects/connect/challenge.jpg"
import design from "../../../../../public/projects/connect/design.jpg"
import discovery from "../../../../../public/projects/connect/discovery.jpg"
...
export default function ConnectPage() {
  ...
  return (
  <>
    <Hero title="Freshbooks Connect" subtitle="New Mobile App for Team Members" src={connect.src} />
    <div className=" flex  flex-col gap-10 px-[5vw] py-14 md:pr-24 xl:pr-[5vw]">
      ...
      <ImageContainer src={persona.src} alt="Freshbooks Connect" />
      ...
      <FullImageContainer src={discovery.src} alt="Freshbooks Connect" />
      ...
      <ImageContainer src={challenge.src} alt="Freshbooks Connect" />
      ...
      <FullImageContainer src={process.src} alt="Freshbooks Connect" />
      ...
      <ImageContainer src={design.src} alt="Freshbooks Connect" />
    ...
    {/* Next Project */}
    <NextProject href="/2025/brick" title="Freshbricks" />
  </>
  );
}
