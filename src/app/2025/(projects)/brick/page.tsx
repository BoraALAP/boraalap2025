...
/**
 * BrickPage preserves the older FreshBricks case study inside /2025.
 * It keeps the original section navigation, metrics, imagery, and next-project link.
 */
...
export default function BrickPage() {
  ...
  return (
   <>
      ...
      {/* Other projects */}
      <NextProject href="/2025/connect" title="Freshbooks Connect" />
      </>
  );
}
