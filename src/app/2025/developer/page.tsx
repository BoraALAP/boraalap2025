...
// TwentyTwentyFiveDeveloperPage preserves the previous developer-mode portfolio.
const TwentyTwentyFiveDeveloperPage = () => {
  return (
...
export default TwentyTwentyFiveDeveloperPage;
