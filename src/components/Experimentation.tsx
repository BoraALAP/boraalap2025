...
/**
 * Experimentation renders the legacy horizontal carousel used by the archived /2025 pages.
 * It measures card width so the next/previous controls advance by visible groups.
 */
