...
export default function Contact() {
  return (
    <section
      id="contact"
      className="relative px-6 py-32 flex flex-col items-center justify-center text-center overflow-hidden"
    >
      {/* Gradient glow */}
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: "radial-gradient(ellipse 50% 50% at center, oklch(75% 0.18 55 / 0.06) 0%, transparent 70%)",
        }}
      />
      ...
      >
        ...
        <a
          ...
          className="text-accent text-lg md:text-xl hover:underline underline-offset-4"
        >
