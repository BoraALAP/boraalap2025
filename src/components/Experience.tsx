...
const education = [
  { company: "Humber College", title: "Creative Advertising", location: "Toronto", period: "2010 – 2014" },
];
...
export default function Experience() {
  return (
    <section id="experience" className="mx-auto max-w-[1100px] px-6 py-16">
      ...
      <motion.h3
        className="mb-2 mt-12 text-sm font-medium uppercase tracking-widest text-muted"
        initial={{ opacity: 0, filter: "blur(4px)" }}
        whileInView={{ opacity: 1, filter: "blur(0px)" }}
        transition={{ duration: 0.4 }}
        viewport={{ once: true }}
