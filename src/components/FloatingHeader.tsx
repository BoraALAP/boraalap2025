...
/**
 * FloatingHeader recreates the old sticky bottom navigation for the /2025 archive.
 * The new homepage does not mount this component, so the legacy switch stays isolated.
 */
