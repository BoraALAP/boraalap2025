...
/**
 * TestimonialCard is the legacy stacked testimonial card used by the /2025 archive.
 * It opens the original modal interaction and scales with the section scroll progress.
 */
