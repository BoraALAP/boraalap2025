/**
 * ProjectCard is the legacy image/interactive card used by the /2025 carousel.
 * It reports its width to the carousel and supports image, component, and external-link states.
 */
